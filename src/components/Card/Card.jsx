...
const Card = ({ title, imageUrl, artist }) => {


    return (
        <section className=" relative carousel-item flex flex-col w-36 min-h-48 space-y-2 lg:bg-[#181818] rounded-lg lg:hover:bg-gradient-to-t from-[#292929] to-[#202020] group  lg:w-48 lg:p-4">
